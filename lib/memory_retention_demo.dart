      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Review Reminder Widget Demo
            _buildDemoSection(
              "🔔 Review Reminder Widget",
              "Shows lessons that are due for review based on spaced repetition algorithm",
              [
                Container(
                  width: double.infinity,
                  child: ReviewReminderWidget(
                    nickname: _testNickname,
                    onReviewCompleted: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Review completed! Great job! 🎉'),
